...
import { CalendarIcon, Loader, Loader2, Receipt } from 'lucide-react';
...
const AddTransactionForm = ({ accounts, categories, editMode = false, initialData = null, }) => {
    ...
    const { register, setValue, handleSubmit, formState: { errors }, watch, getValues, reset, } = useForm({
        ...
        : {
            ...
            amount: "",
            description: "",
            accountId: accounts.find((ac) => ac.isDeafult)?.id,
            date: new Date(),
            isRecurring: false,
    ...
    const handleScanComplete = (scannedData) => {
      ...
      if (matchedCategory) {
        setValue("category", matchedCategory.id); // ✅ id, not name
      }
    }
        }
    };
                ...
                <div className='space-y-2'>
                    ...
                    >
                        ...
                        <SelectContent>
                            ...
                            <CreateAccountDrawer>
                                <Button className="w-full select-none items-center text-sm outline-none" variant="ghost"> Create Account</Button>
                            </CreateAccountDrawer>
