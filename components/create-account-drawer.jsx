            ...
            <DrawerContent>
                ...
                <div className="px-4 pb-4">
                    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="type" className="text-sm font-medium"> Account Type
                            </label>
                         ...
                         <div className="space-y-2">
                            <label htmlFor="balance" className="text-sm font-medium"> Initial Balance
                            </label>
                            <Input id="balance"
                            type="number"
                            step="0.01"
                        ...
                        <div className="flex items-center justify-between rounded-lg border p-3">
                            ...
                            <p className="text-sm text-muted-foreground">This account will be selected by desfault for transactions</p>
                            </div>
                            <Switch id="isDefault" 
